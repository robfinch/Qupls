...
#define LSDISP(x)	(((x) & 0xffffLL) << 28LL)
...
#define BFOFFS(x)	(((x) & 0x7fLL) << 21LL)
#define BFWID(x)	(((x) & 0x7fLL) << 28LL)
#define BFMB(x)	(((x) & 0x7fLL) << 21LL)
#define BFME(x)	(((x) & 0x7fLL) << 28LL)
#define BFFUNC(x)	(((x) & 0x7fLL) << 41LL)
