...
mnemonic mnemonics[]={
#include "opcodes.h"
	"abs",	{OP_REG,OP_REG,0,0,0}, {R3,CPU_ALL,0,OPC(104LL),4,SZ_INT,0},	// Fix this

	"add", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(4LL)|MS3(4LL)|OP3(3LL)|OPC(104LL),4,SZ_INT,3},	
	"add", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(4LL),4,SZ_INTI,3},	
	"addi", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(4LL),4,SZ_INTI,3},	

	"and", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(0LL)|MS3(4LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"and", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(8LL),4,SZ_INTI,3},	
	"andi", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(8LL),4,SZ_INTI,3},	

	"asl", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(83LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"asl", {OP_REG,OP_REG,OP_IMM,0,0}, {R2,CPU_ALL,0,0,R2FUNC(83LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	

	"asr", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(82LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"asr", {OP_REG,OP_REG,OP_IMM,0,0}, {R2,CPU_ALL,0,0,R2FUNC(82LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
...
//	"bcs",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,CM(1LL)|OPC(40LL),8,SZ_UNSIZED,0},
	"beq",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(0LL)|OPC(11LL),8,SZ_INT,3},
	"beq",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(0LL)|R2FUNC(3LL)|OPC(104LL),8,SZ_INT,3},
//	"beq",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,COND(0LL)|OPC(24LL),6,SZ_INT,2},
//	"beqz",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,OPC2(32LL)|BRMS(2LL)|COND(0LL)|OPC(11LL),8,SZ_INT,3, FLG_BZ},
	"beqz",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,COND(0LL)|OPC(24LL),4,SZ_INT,3, FLG_BZ},

//	"beven",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(13LL)|OPC(28LL),8},

	"bge",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(4LL)|OPC(11LL),8,SZ_INT,3},
	"bge",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(4LL)|R2FUNC(3LL)|OPC(104LL),8,SZ_INT,3},
	"bgez",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,COND(4LL)|OPC(24LL),4,SZ_INT,3, FLG_BZ},
//	"bge",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(4LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bgeu",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(4LL)|OPC(19LL),8,SZ_INT,3},
	"bgeu",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(4LL)|R2FUNC(6LL)|OPC(104LL),8,SZ_INT,3},
//	"bgeu",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(4LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bgt",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(5LL)|OPC(11LL),8,SZ_INT,3},
	"bgt",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(5LL)|R2FUNC(3LL)|OPC(104LL),8,SZ_INT,3},
	"bgtz",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,COND(5LL)|OPC(24LL),4,SZ_INT,3, FLG_BZ},
//	"bgt",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(5LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bgtu",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(5LL)|OPC(19LL),8,SZ_INT,3},
	"bgtu",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(5LL)|R2FUNC(6LL)|OPC(104LL),8,SZ_INT,3},
...
//	"bhs",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,CM(1LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"ble",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(3LL)|OPC(11LL),8,SZ_INT,3},
	"ble",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(3LL)|R2FUNC(3LL)|OPC(104LL),8,SZ_INT,3},
	"blez",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,COND(3LL)|OPC(24LL),4,SZ_INT,3, FLG_BZ},
//	"ble",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(3LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bleu",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(3LL)|OPC(19LL),8,SZ_INT,3},
	"bleu",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(3LL)|R2FUNC(6LL)|OPC(104LL),8,SZ_INT,3},
...
//	"bls",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,CM(1LL)|OPC(42LL),6,SZ_UNSIZED,0},
	"blt",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(2LL)|OPC(11LL),8,SZ_INT,3},
	"blt",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(2LL)|R2FUNC(3LL)|OPC(104LL),8,SZ_INT,3},
	"bltz",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,COND(2LL)|OPC(24LL),4,SZ_INT,3, FLG_BZ},
...
//	"blt",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(2LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bltu",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(2LL)|OPC(19LL),8,SZ_INT,3},
	"bltu",	{OP_REG|OP_IMM,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(2LL)|R2FUNC(6LL)|OPC(104LL),8,SZ_INT,3},
//	"bltu",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(2LL)|OPC(40LL),6,SZ_UNSIZED,0},
	...
	"bne",	{OP_REG|OP_IMM,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(1LL)|OPC(11LL),8,SZ_INT,3},
	"bne",	{OP_REG|OP_IMM,OP_REG|OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,0,OPC2(32LL)|COND(1LL)|OPC(104LL),8,SZ_INT,3},
	
//	"bne",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,0,BFN(1LL)|OPC(40LL),6,SZ_UNSIZED,0},

	"bnez",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,COND(1LL)|OPC(24LL),4,SZ_INT,3, FLG_BZ},
//	"bnez",	{OP_REG|OP_IMM,OP_IMM,0,0,0}, {BZ,CPU_ALL,0,0,OPC2(32LL)|BRMS(2LL)|COND(1LL)|OPC(11LL),8,SZ_INT,3, FLG_BZ},
//	"bodd",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(5LL)|OPC(28LL),8},
//	"bodd",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(5LL)|OPC(28LL),8},

	"bra",	{OP_IMM,0,0,0,0}, {B2,CPU_ALL,0,0,OPC(32LL),4,SZ_UNSIZED,0},
	"branch",	{OP_IMM,0,0,0,0}, {B2,CPU_ALL,0,0,OPC(32LL),4,SZ_UNSIZED,0},

	"brk",	{0,0,0,0,0}, {R1,CPU_ALL,0,0,0x00,6,SZ_UNSIZED,0},

	"bsr",	{OP_IMM,0,0,0,0}, {B2,CPU_ALL,0,0,RD(1LL)|OPC(32LL),4,SZ_UNSIZED,0},
	"bsr",	{OP_REG,OP_IMM,0,0,0}, {BL2,CPU_ALL,0,0,OPC(32LL),4,SZ_UNSIZED,0},
	...
	"cmp", {OP_REG,OP_REG,OP_REG,0,0}, {R3,CPU_ALL,0,0,MS3(4LL)|R3FUNC(3LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"cmp", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(11LL),4,SZ_INTI,3,0},	
	"cmpi", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(11LL),4,SZ_INTI,3,0},	
	"cmpu", {OP_REG,OP_REG,OP_REG,0,0}, {R3,CPU_ALL,0,0,MS3(4LL)|R3FUNC(6LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"cmpu", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(19LL),4,SZ_INTI,3,0},	
	"cmpui", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(19LL),4,SZ_INTI,3,0},	

	"cntlz", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0,0x00000001,6},
	"cntpop", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0,0x04000001,6},

	"com", {OP_REG,OP_REG,0,0,0}, {RI,CPU_ALL,0,0,0x7ff80000LL|OPC(10LL),4},

	"cpuid", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0,0x41LL,4},
	...
	"enter", {OP_REG,OP_REG,OP_REG,OP_IMM,0}, {ENTER,CPU_ALL,0,0,OPC(52LL),4,SZ_UNSIZED,0},	

	"eor", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R3FUNC(2LL)|MS3(4LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"eor", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(10LL),4,SZ_INTI,3},	
	"eori", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(10LL),4,SZ_INTI,3},	

	"exit", {OP_REG,OP_REG,OP_REG,OP_IMM,0}, {LEAVE,CPU_ALL,0,0,OPC(53LL),4,SZ_UNSIZED,0},	
	...
	"jmp",	{OP_REGIND,0,0,0,0}, {J2,CPU_ALL,0,0,OPC(38LL),4, SZ_UNSIZED,0},
	"jmp",	{OP_REG,0,0,0,0}, {J2,CPU_ALL,0,0,OPC(38LL),4, SZ_UNSIZED,0},
	"jmp",	{OP_IMM,0,0,0,0}, {J4,CPU_ALL,0,0,OPC(33LL),4, SZ_UNSIZED,0},
	"jsr",	{OP_REGIND,0,0,0}, {J2,CPU_ALL,0,0,OPC(38LL),4, SZ_UNSIZED,0},
	"jsr",	{OP_LK,OP_IND_SCNDX,0,0,0}, {JSCNDX,CPU_ALL,0,0,R2FUNC(24LL)|0x80000000L|OPC(2LL),4, SZ_UNSIZED,0},
	"jsr",	{OP_LK,OP_REGIND,0,0,0}, {JL2,CPU_ALL,0,0,OPC(38LL),4, SZ_UNSIZED,0},
	"jsr",	{OP_LK,OP_IMM,0,0,0}, {JL4,CPU_ALL,0,0,OPC(33LL),4, SZ_UNSIZED,0},
	"jsr",	{OP_IMM,0,0,0,0}, {J4,CPU_ALL,0,0,OPC(33LL),4, SZ_UNSIZED,0},
	...
	"ldb",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(64LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"ldb",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(64LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"ldb",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,OPC(64LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP},	

	"ldbu",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(65LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"ldbu",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(65LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"ldbu",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,OPC(65LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP},	
	"ldbz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(65LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"ldbz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(65LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"ldbz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,OPC(65LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP},	

	"ldh",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(72LL),4, SZ_UNSIZED, SZ_HEXI, FLG_LSDISP|FLG_REGIND},	
	"ldh",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(72LL),4, SZ_UNSIZED, SZ_HEXI, FLG_LSDISP|FLG_REGIND},	
	"ldh",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSFUNC(8LL)|OPC(79LL),4, SZ_UNSIZED, SZ_HEXI, FLG_LSDISP},	

	"ldi", {OP_REG,OP_NEXTREG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(4LL),4,SZ_UNSIZED, 0},	

	"ldo",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"ldo",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"ldo",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)||OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	
	"ldou",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"ldou",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"ldou",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	
	"ldoz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"ldoz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"ldoz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	

	"ldt",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(2)|OPC(64LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"ldt",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(2)|OPC(64LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"ldt",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(2)|OPC(64LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP},	
	"ldtu",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(2)|OPC(65LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"ldtu",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(2)|OPC(65LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"ldtu",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(2)|OPC(65LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP},	
	"ldtz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(2)|OPC(65LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"ldtz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(2)|OPC(65LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"ldtz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(2)|OPC(65LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP},	

	"ldw",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(1)|OPC(64LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"ldw",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(1)|OPC(64LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"ldw",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(1)|OPC(64LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP},	
	"ldwu",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(1)|OPC(65LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"ldwu",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(1)|OPC(65LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"ldwu",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(1)|OPC(65LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP},	
	"ldwz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(1)|OPC(65LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"ldwz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(1)|OPC(65LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"ldwz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(1)|OPC(65LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP},	

	"load",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},
	"load",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},
	"load",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)|OPC(64LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	

	"loada",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(88LL),4, SZ_UNSIZED, 0, FLG_LSDISP},	
	"loada",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(88LL),4, SZ_UNSIZED, 0, FLG_LSDISP},	
	"loada",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,S(3)|OPC(88LL),4, SZ_UNSIZED, 0, FLG_LSDISP},	

	"loadi", {OP_REG,OP_NEXTREG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(22LL),4,SZ_INTI,3},	

	"lsr", {OP_REG,OP_REG,OP_REG,0,0}, {R3,CPU_ALL,0,0,R3FUNC(84LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"lsr", {OP_REG,OP_REG,OP_IMM,0,0}, {R3,CPU_ALL,0,0,R3FUNC(84LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	...
	"mov", {OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,0,R2FUNC(15LL)|OPC(104LL),4, SZ_UNSIZED, 0},	
	"move", {OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,0,R2FUNC(15LL)|OPC(104LL),4, SZ_UNSIZED, 0},	
	"move_sp", {OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,0,0x800000LL|OPC(15LL),4, SZ_UNSIZED, 0},	
...
//	"move",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,0x0817F00000AALL,8},
	...
	"nand", {OP_VREG,OP_VREG,OP_VREG|OP_REG|OP_IMM7,OP_VREG|OP_REG|OP_IMM7,0}, {R3,CPU_ALL,0,0,0x000000000102LL,4},	
	"nand", {OP_VREG,OP_VREG,OP_VREG|OP_REG|OP_IMM7,OP_VREG|OP_REG|OP_IMM7,OP_VMREG}, {R3,CPU_ALL,0,0,0x000000000102LL,4},	
	"nand", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(8LL)|OPC(104LL),4, SZ_INT, 3},	
	"nand", {OP_REG,OP_REG,OP_IMM,0}, {R2,CPU_ALL,0,0,R2FUNC(8LL)|OPC(104LL),4, SZ_INT, 3},	

	"neg", {OP_REG,OP_NEXTREG,OP_REG,0,0}, {R2,CPU_ALL,0,0,0x0000000DLL,6},	
//	"neg",	{OP_REG,OP_REG,0,0,0}, {R3,CPU_ALL,0,0x0A000001LL,4},

	"nop",	{0,0,0,0,0}, {BITS16,CPU_ALL,0,0,0xffffffffLL,4, SZ_UNSIZED, 0},
	...
	"or", {OP_REG,OP_REG,OP_REG,0,0}, {R3,CPU_ALL,0,0,R3FUNC(1LL)|MS3(4LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"or", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(9LL),4,SZ_INTI,3},	
	"ori", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(9LL),4,SZ_INTI,3},	
...
//	"or", {OP_VREG,OP_VREG,OP_VREG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(1LL)|OPC(38LL),8,SZ_UNSIZED,0},	
	...
	"pop",	{OP_REG,OP_REG,OP_REG,OP_REG,0},{R4,CPU_ALL,0,0,0x600055LL,4},	
	"pop",	{OP_REG,OP_REG,OP_REG,0,0},{R3,CPU_ALL,0,0,0x400055LL,4},	
	"pop",	{OP_REG,OP_REG,0,0,0},{R2,CPU_ALL,0,0,0x200055LL,4},	
	...
	"push",	{OP_REG,OP_REG,OP_REG,OP_REG,0},{R4,CPU_ALL,0,0,0x600054LL,4},	
	"push",	{OP_REG,OP_REG,OP_REG,0,0},{R3,CPU_ALL,0,0,0x400054LL,4},	
	"push",	{OP_REG,OP_REG,0,0,0},{R3,CPU_ALL,0,0,0x200054LL,4},	
...
//	"ret", {OP_REG,0,0,0,0}, {RTDR,CPU_ALL,0,0x80000000LL|R2FUNC(4LL)|OPC(2LL),8,SZ_INTALL,SZ_HEXI},	
	...
	"rol", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,0,SHFUNC(0LL)|OPC(88LL),4,SZ_UNSIZED,0},	
	"rol", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,0,SHI(1LL)|SHFUNC(0LL)|OPC(88LL),4,SZ_UNSIZED,0},	
	"ror", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,0,SHFUNC(1LL)|OPC(88LL),4,SZ_UNSIZED,0},	
	"ror", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,0,SHI(1LL)|SHFUNC(1LL)|OPC(88LL),4,SZ_UNSIZED,0},	

	"rtd", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {RTDR,CPU_ALL,0,0,0x80000000LL|R2FUNC(4LL)|LKS(1)|OPC(2LL),4,SZ_INTALL,SZ_HEXI},	
	"rtd", {OP_NEXTREG,OP_IMM,OP_IMM,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(0LL)|LKS(1LL)|OPC(35LL),4,SZ_INTALL,SZ_HEXI},	
	"rtd", {OP_NEXTREG,OP_IMM,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(0LL)|LKS(1LL)|OPC(35LL),4,SZ_INTALL,SZ_HEXI},	

	"rte",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(1LL)|OPC(35LL), 4},
	"rte2",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(2LL)|OPC(35LL), 4},
	"rti",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(1LL)|OPC(35LL), 4},
	"rti2",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(2LL)|OPC(35LL), 4},
	"rts", {OP_NEXTREG,OP_REG,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(0LL)|OPC(35LL),4,SZ_INTALL,SZ_HEXI},	
	"rts", {0,0,0,0,0}, {RTDR,CPU_ALL,0,0,RTYPE(0LL)|RA(56LL)|OPC(35LL),4,SZ_UNSIZED,0},	
	...
	"seq", {OP_REG,OP_REG,OP_REG,0,0}, {R3,CPU_ALL,0,0,MS3(4LL)|R3FUNC(120LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
//	"seq", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,0,R2FUNC(16LL)|OPC(26LL),8,SZ_UNSIZED,0},	
	"seq", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,MS3(4LL)|R3FUNC(120LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"sle", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(19LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sle", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,0,R2FUNC(19LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sle", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,0,R2FUNC(19LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sleu", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(21LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sleu", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,0,R2FUNC(21LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sleu", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,0,R2FUNC(21LL)|OPC(26LL),4,SZ_UNSIZED,0},	

	"sll", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,0,SHFUNC( 0LL)|OPC(83LL),4,SZ_UNSIZED,0},	
	"sll", {OP_REG,OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,0,SHFUNC( 8LL)|OPC(83LL),4,SZ_UNSIZED,0},	
	"sll", {OP_REG,OP_REG,OP_IMM,0,0}, {SI,CPU_ALL,0,0,SHFUNC( 8LL)|OPC(83LL),4,SZ_UNSIZED,0},	

	"slt", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(18LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"slt", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,0,R2FUNC(18LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"slt", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(3LL),4,SZ_UNSIZED,0},	
...
//	"sne", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {R3RR,CPU_ALL,0,0,0x4E0000000002LL,8},	
	"sne", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(17LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sne", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,0,R2FUNC(17LL)|OPC(26LL),4,SZ_UNSIZED,0},	
	"sne", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,0,R2FUNC(17LL)|OPC(26LL),4,SZ_UNSIZED,0},	

	"sra", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,0,SHFUNC( 2LL)|OPC(83LL),4,SZ_UNSIZED,0},	
	"sra", {OP_REG,OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,0,SHFUNC(10LL)|OPC(83LL),4,SZ_UNSIZED,0},	

	"srl", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,0,SHFUNC( 1LL)|OPC(83LL),4,SZ_UNSIZED,0},	
	"srl", {OP_REG,OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,0,SHFUNC( 9LL)|OPC(83LL),4,SZ_UNSIZED,0},	
	...
	"stb",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(80LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"stb",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(80LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP|FLG_REGIND},	
	"stb",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSFUNC(0)|OPC(87LL),4, SZ_UNSIZED, SZ_BYTE, FLG_LSDISP},	

	"sth",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(84LL),4, SZ_UNSIZED, SZ_HEXI, FLG_LSDISP|FLG_REGIND},	
	"sth",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(84LL),4, SZ_UNSIZED, SZ_HEXI, FLG_LSDISP|FLG_REGIND},	
	"sth",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSFUNC(4LL)|OPC(87LL),4, SZ_UNSIZED, SZ_HEXI, FLG_LSDISP},	

	"sto",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"sto",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"sto",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	
	"store",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"store",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"store",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	
	"store",	{OP_IMM,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"store",	{OP_IMM,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP|FLG_REGIND},	
	"store",	{OP_IMM,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSSIZE(3)|OPC(83LL),4, SZ_UNSIZED, SZ_OCTA, FLG_LSDISP},	

	"stt",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(82LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"stt",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(82LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP|FLG_REGIND},	
	"stt",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,LSFUNC(2LL)|OPC(87LL),4, SZ_UNSIZED, SZ_TETRA, FLG_LSDISP},	

	"stw",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(81LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"stw",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(81LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"stw",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,OPC(81LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP},	
	"stw",	{OP_IMM,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,0,OPC(81LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"stw",	{OP_IMM,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,0,OPC(81LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP|FLG_REGIND},	
	"stw",	{OP_IMM,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,0,OPC(81LL),4, SZ_UNSIZED, SZ_WYDE, FLG_LSDISP},	

	"sub", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(4LL)|NRB(1LL)|OP3(3LL)|OPC(2LL),4,SZ_UNSIZED,0},	
	"sub", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(4LL),4,SZ_UNSIZED,0, FLG_NEGIMM},
	"subtract", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(4LL)|NRB(1LL)|OP3(3LL)|OPC(2LL),4,SZ_UNSIZED,0},	
	"subtract", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(4LL),4,SZ_UNSIZED,0, FLG_NEGIMM},
...
/* 0000_1010_0001_0001_1111_0000_0000_0000_0000_0000_AALL */
	...
	"xor", {OP_REG,OP_REG,OP_REG,0,0}, {R3,CPU_ALL,0,0,R3FUNC(2LL)|MS3(4LL)|OP3(1LL)|OPC(104LL),4,SZ_INT,3},	
	"xor", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(10LL),4,SZ_INTI,3},	
	"xori", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,0,OPC(10LL),4,SZ_INTI,3},	

	"zseq", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,0,R2FUNC(120LL)|OPC(2LL),4,SZ_UNSIZED,0},	
	...
	if (insn) {
		...
		case R3:
			if (i==0)
				...
				insn->opcode |= ((op->basereg) << 13LL);
			else if (i==2)
				insn->opcode |= ((op->basereg) << 19LL);
			else if (i==3)
				insn->opcode |= ((op->basereg) << 25LL);
			break;
		...
		case REGIND:
			if (insn->opcode_size==3) {
				if (i==0)
					...
					insn->opcode = insn->opcode | ((op->basereg) << 14LL);
			}
			else {
				if (i==0)
					insn->opcode |= RT(op->basereg);
				else if (i==1)
					insn->opcode = insn->opcode | ((op->basereg) << 13LL);
				else if (i==2)
					insn->opcode = insn->opcode | ((op->basereg) << 19LL);
			}
			break;
		...
		case SCNDX:
			if (i==0)
				...
				insn->opcode = insn->opcode | ((op->basereg) << 13LL);
				insn->opcode = insn->opcode | ((op->ndxreg) << 19LL);
			}
			break;
		...
		case SH:
			if (i==0) {
				insn->opcode = insn->opcode | ((op->basereg) << 9LL);
			}
			else if (i==1)
				insn->opcode = insn->opcode | ((op->basereg) << 15LL);
			else if (i==2)
				insn->opcode = insn->opcode | ((op->basereg) << 21LL);
			else if (i==3)
				insn->opcode = insn->opcode | ((op->basereg) << 27LL);
			break;
...
//			printf("MV: %d\r\n",op->basereg);
		...
		case BL2:
			if (i==0) {
				insn->opcode |= (RT(op->basereg|0x20));
			}
			break;			
	...
	if (i==1) {
		if (insn) {
			if (mnemo->ext.flags & FLG_LSDISP) {
				...
				if (!is_nbit(hval,15))
					encode_cpfx(insn,((hval.lo >> 15LL) << 12LL) | 100LL | 1LL);
				if (!is_nbit(hval,37))
					encode_cpfx(insn,((hval.lo >> 37LL) << 12LL) | 100LL | 0x80LL | 1LL);
				if (!is_nbit(hval,59))
					encode_cpfx(insn,((hval.lo >> 59LL) << 12LL) | 100LL | 0x100LL | 1LL);
			}
			else {
				insn->opcode = insn->opcode | ((hval.lo & 0xfffLL) << 17LL);
				if (!is_nbit(hval,12))
					encode_cpfx(insn,((hval.lo >> 12LL) << 12LL) | 100LL | 1LL);
				if (!is_nbit(hval,34))
					encode_cpfx(insn,((hval.lo >> 34LL) << 12LL) | 100LL | 0x80LL | 1LL);
				if (!is_nbit(hval,56))
					encode_cpfx(insn,((hval.lo >> 56LL) << 12LL) | 100LL | 0x100LL | 1LL);
			}
		}
	}
	else if (i==2) {
...
static size_t encode_immed_LDI(instruction_buf* insn, thuge hval, int i)
{
	...
	if (i==1) {
		if (insn) {
			if (is_nbit(hval,12)) {
				insn->opcode = insn->opcode | (((hval.lo >> 1LL) & 0xfffLL) << 19LL | ((hval.lo & 1LL) << 12LL));
			}
			else if (is_nbit(hval,34)) {
				insn->opcode = insn->opcode | (((hval.lo >> 1LL) & 0xfffLL) << 19LL | ((hval.lo & 1LL) << 12LL));
				encode_cpfx(insn,(((hval.lo >> 12LL) & 0x3fffffLL) << 12LL) | 0x7fLL | 0x200LL);
			}
			else {
				insn->opcode = insn->opcode | (((hval.lo >> 1LL) & 0xfffLL) << 19LL | ((hval.lo & 1LL) << 12LL));
				encode_cpfx(insn,(((hval.lo >> 12LL) & 0x3fffffLL) << 12LL) | 0x7fLL | 0x200LL);
				encode_cpfx(insn,(((hval.lo >> 34LL) & 0x3fffffLL) << 12LL) | 0x7fLL | 0x600LL);
			}
		}
	}
	*/
	...
	if (constexpr) {
		...
		if (mnemo->ext.format==LDI) {
			...
			if (insn) {
				switch(i) {
				case 3:
					insn->opcode = insn->opcode | (((-val.lo >> 3LL) & 0x7fLL) << 25LL);
					break;
				}
			}
		}
...
static size_t encode_branch_B(instruction_buf* insn, operand* op, int64_t val, int i, unsigned int flags)
{
	...
	if (op->type == OP_IMM) {
		...
		case 1:
	  	if (flags & FLG_BZ) {
				insn->opcode = (insn->opcode & 0x800001ffffffLL) | ((val & 0x7ffffeLL) << 24LL);
	  	}
	  	else {
				hg = huge_from_int(val);
				/*
		...
		case 2:
	  	if (insn) {
  			insn->opcode |= (((val & 0xffffffLL) >> 1LL) << 41LL);
  		}
			break;
#endif			
		}
...
static size_t encode_branch_BL2(instruction_buf* insn, operand* op, int64_t val, int i)
{
	...
	if (op->type == OP_IMM) {
		if (insn) {
			switch(i) {
			case 1:
  			tgt = (((val >> 1LL) & 0x7ffffffffLL) << 13LL);
  			insn->opcode |= tgt;
		  	break;
			}
		}
...
static int encode_branch(instruction_buf* insn, mnemonic* mnemo, operand* op, int64_t val, int* isize, int i)
{
	...
	*isize = 4;
	...
	// Nothing to do but encode the displacement for BZ
	// Displacement is already shifted right twice.
	case BZ:
//		*isize = encode_branch_B(insn, op, val, i+1, mnemo->ext.flags);
		insn->opcode = insn->opcode | (((val >> 1LL) & 0x7fffLL) << 17LL) | ((val & 1LL) << 10LL);
		*isize = 4;
  	return (1);
