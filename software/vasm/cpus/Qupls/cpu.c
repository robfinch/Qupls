...
mnemonic mnemonics[]={
	...
	"add", {OP_VREG,OP_VREG,OP_VREG,0,0}, {R2,CPU_ALL,0,R2FUNC(4LL)|OP3(8LL)|OPC(38LL),6,SZ_UNSIZED,0},	
	"add", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(4LL)|OP3(3LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"add", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(4LL),6,SZ_UNSIZED,0,0,OPC(2LL)|R2FUNC(4LL)},	

	"addh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x10000LL|OPC(49LL),6,SZ_UNSIZED,0,0},
	"addm",{OP_REG,OP_IMM,0,0,0}, {RISM,CPU_ALL,0,0x8000LL|OPC(49LL),6,SZ_UNSIZED,0,0},
	"adds",{OP_REG,OP_IMM,OP_IMM,0,0}, {RIS,CPU_ALL,0,OPC(49LL),6,SZ_UNSIZED,0,0},

	"and", {OP_VREG,OP_VREG,OP_VREG,0,0}, {R2,CPU_ALL,0,R2FUNC(0)|OPC(38LL),6,SZ_UNSIZED,0},	
	"and", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(0)|OPC(2LL),6,SZ_UNSIZED,0},	
	"and", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(0)|OPC(2LL),6,SZ_UNSIZED,0},	
	"and", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(8LL),6,SZ_UNSIZED,0,0},	
	
	"andh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x10000LL|OPC(50LL),6,SZ_UNSIZED,0,0},
	"andm",{OP_REG,OP_IMM,0,0,0}, {RISM,CPU_ALL,0,0x8000LL|OPC(50LL),6,SZ_UNSIZED,0,0},
	"ands",{OP_REG,OP_IMM,OP_IMM,0,0}, {RIS,CPU_ALL,0,OPC(50LL),6,SZ_UNSIZED,0,0},

	"asl", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,SHFUNC(0x0LL)|OPC(88LL),6,SZ_UNSIZED,0},	
	"asl", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,SHFUNC(0x0LL)|0x2000000000|OPC(88LL),6,SZ_UNSIZED,0},	
	"asr", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,SHFUNC(0x2LL)|OPC(88LL),6,SZ_UNSIZED,0},	
	"asr", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,SHFUNC(0x2LL)|0x2000000000|OPC(88LL),6,SZ_UNSIZED,0},	

	"atom", {OP_IMM,0,0,0,0}, {ATOM,CPU_ALL,0,FMT2(0)|OPC(122LL),6,SZ_UNSIZED,0},	

	"bbc",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,OPC(44LL),6,SZ_UNSIZED,0},
	"bbc",	{OP_REG,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,OPC(46LL),6,SZ_UNSIZED,0, FLG_UI6},
	"bbs",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,OPC(45LL),6,SZ_UNSIZED,0},
	"bbs",	{OP_REG,OP_IMM,OP_IMM,0,0}, {B,CPU_ALL,0,OPC(47LL),6,SZ_UNSIZED,0, FLG_UI6},
	"bcc",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,CM(1LL)|OPC(41LL),6,SZ_UNSIZED,0},
...
//	"bcs",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,CM(1LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"beq",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"beq",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(4LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"beqz",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,BFN(4LL)|OPC(40LL),6,SZ_UNSIZED,0},

//	"beven",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(13LL)|OPC(28LL),6},

	"bge",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bge",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(4LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bgeu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bgeu",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(4LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bgt",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(5LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bgt",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(5LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bgtu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(5LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bgtu",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(5LL)|OPC(40LL),6,SZ_UNSIZED,0},
//	"bhi",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,CM(1LL)|OPC(43LL),6,SZ_UNSIZED,0},
//	"bhs",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,CM(1LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"ble",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(3LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"ble",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(3LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bleu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(3LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bleu",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(3LL)|OPC(40LL),6,SZ_UNSIZED,0},
//	"blo",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,CM(1LL)|OPC(40LL),6,SZ_UNSIZED,0},
//	"bls",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,CM(1LL)|OPC(42LL),6,SZ_UNSIZED,0},
	"blt",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(2LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"blt",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(2LL)|OPC(41LL),6,SZ_UNSIZED,0},
	"bltu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(2LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bltu",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(2LL)|OPC(40LL),6,SZ_UNSIZED,0},

	"bmap", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,FMT3(0)|R2FUNC(35)|IM2(0)|OPC(2LL),6,SZ_UNSIZED,0},	
	"bmm", 	{OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,FMT3(0)|R2FUNC(34)|IM2(0)|OPC(2LL),6,SZ_UNSIZED,0},	

	"bne",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(1LL)|OPC(40LL),6,SZ_UNSIZED,0},
	"bne",	{OP_REG,OP_IMM,OP_IMM,0,0}, {BI,CPU_ALL,0,BFN(1LL)|OPC(40LL),6,SZ_UNSIZED,0},

	"bnez",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,BFN(1LL)|OPC(40LL),6,SZ_UNSIZED,0},
//	"bodd",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(5LL)|OPC(28LL),6},
//	"bodd",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(5LL)|OPC(28LL),6},

	"bra",	{OP_IMM,0,0,0,0}, {B2,CPU_ALL,0,OPC(32LL),6,SZ_UNSIZED,0},
	"branch",	{OP_IMM,0,0,0,0}, {B2,CPU_ALL,0,OPC(32LL),6,SZ_UNSIZED,0},

	"brk",	{0,0,0,0,0}, {R1,CPU_ALL,0,0x00,6,SZ_UNSIZED,0},

	"bsr",	{OP_IMM,0,0,0,0}, {B2,CPU_ALL,0,LKT(1LL)|OPC(32LL),6,SZ_UNSIZED,0},
	...
	"clr", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(56LL)|OPC(13LL),6},	
	"clr", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,OP_IMM,0}, {BFR3II,CPU_ALL,0,FUNC3(0LL)|OPC(13LL),6},	

	"cmovnz", 	{OP_REG,OP_REG,OP_REG,OP_REG,0}, {R3,CPU_ALL,0,0x5A0000000002LL,6},	

	"cmp", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(3LL)|IM2(0)|OPC(2LL),6,SZ_UNSIZED,0},	
	"cmp", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(3LL)|IM2(1)|OPC(2LL),6,SZ_UNSIZED,0},	
	"cmp", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(11LL),6,SZ_UNSIZED,0,0},	

	"cntlz", {OP_VREG,OP_VREG,0,0,0}, {R1,CPU_ALL,0,0x00000101,6},
	"cntlz", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0x00000001,6},
	"cntpop", {OP_VREG,OP_VREG,0,0,0}, {R1,CPU_ALL,0,0x04000101,6},
	"cntpop", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0x04000001,6},

	"com",	{OP_VREG,OP_VREG,0,0,0}, {R3II,CPU_ALL,0,0x1417F00001AALL,6},
	"com", {OP_REG,OP_REG,0,0,0}, {RI,CPU_ALL,0,0xfffff80000LL|OPC(10LL),6},

	"cpuid", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0x41LL,4},
	
	"csrrc", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,FUNC3(3)|OPC(7),6,SZ_UNSIZED,0},
	"csrrd", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,FUNC3(0)|OPC(7),6,SZ_UNSIZED,0},
	"csrrs", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,FUNC3(2)|OPC(7),6,SZ_UNSIZED,0},
	"csrrw", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,FUNC3(1)|OPC(7),6,SZ_UNSIZED,0},
	"csrwr", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,FUNC3(1)|OPC(7),6,SZ_UNSIZED,0},

	"dbra",	{OP_IMM,0,0,0,0},{B,CPU_ALL,0,0x00001F000021LL,6,SZ_UNSIZED,0},
	...
	"div", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(17LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"div", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(13LL),6,SZ_UNSIZED,0},	
	...
	"divu", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(20LL)|OPC(2LL),6},	
	"divu", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(21LL),6},

	"djmp",	{OP_IMM,0,0,0,0},{J2,CPU_ALL,0,0x000000000021LL,6},
	"djmp",	{OP_LK,OP_IMM,0,0,0},{JL2,CPU_ALL,0,0x000000000021LL,6},

	"enor", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"enor", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"enor", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	

	"enter", {OP_IMM,OP_IMM,0,0,0}, {ENTER,CPU_ALL,0,OPC(52LL),6,SZ_UNSIZED,0},	

	"eor", {OP_VREG,OP_VREG,OP_VREG,0,0}, {R2,CPU_ALL,0,R2FUNC(2LL)|OPC(38LL),6,SZ_UNSIZED,0},	
	"eor", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(2LL)|OP3(5LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"eor", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"eor", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(10LL),6,SZ_UNSIZED,0,0},	
	
	"eorh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x10000LL|OPC(59LL),6,SZ_UNSIZED,0,0},
	"eorm",{OP_REG,OP_IMM,0,0,0}, {RISM,CPU_ALL,0,0x8000LL|OPC(59LL),6,SZ_UNSIZED,0,0},
	"eors",{OP_REG,OP_IMM,OP_IMM,0,0}, {RIS,CPU_ALL,0,OPC(59LL),6,SZ_UNSIZED,0,0},

	"ext",	{OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(61)|OPC(13),6,SZ_INTALL,SZ_HEXI},
	"ext",	{OP_REG,OP_REG,OP_IMM,OP_IMM,0}, {BFR3II,CPU_ALL,0,FUNC3(5)|OPC(13),6,SZ_INTALL,SZ_HEXI},
	"exts",	{OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(61)|OPC(13),6,SZ_INTALL,SZ_HEXI},
	"exts",	{OP_REG,OP_REG,OP_IMM,OP_IMM,0}, {BFR3II,CPU_ALL,0,FUNC3(5)|OPC(13),6,SZ_INTALL,SZ_HEXI},
	"extu",	{OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(60)|OPC(13),6,SZ_INTALL,SZ_HEXI},
	"extu",	{OP_REG,OP_REG,OP_IMM,OP_IMM,0}, {BFR3II,CPU_ALL,0,FUNC3(4)|OPC(13),6,SZ_INTALL,SZ_HEXI},

	"fadd", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,0,0}, {R2,CPU_ALL,0,FUNC5(4LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fadd", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,0}, {RI,CPU_ALL,0,OPC(20LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fcmp", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,0,0}, {R2,CPU_ALL,0,FUNC5(5LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fcmp", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,0}, {RI,CPU_ALL,0,OPC(21LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fcmp", {OP_VREG|OP_REG,OP_IMM,OP_VREG|OP_REG,0}, {RIV,CPU_ALL,0,0x80000000LL|OPC(21LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	
	"fcvtdq", {OP_VREG|OP_REG,OP_VREG|OP_REG,0,0,0}, {R1,CPU_ALL,0,FLT1(11)|FUNC5(1)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	
	"fdiv", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,0,0}, {R2,CPU_ALL,0,FUNC5(7LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fdiv", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,0}, {RI,CPU_ALL,0,OPC(23LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fdiv", {OP_VREG|OP_REG,OP_IMM,OP_VREG|OP_REG,0}, {RIV,CPU_ALL,0,0x80000000LL|OPC(23LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fence",{OP_IMM,0,0,0,0},{BITS16,CPU_ALL,0,OPC(114LL),6,SZ_UNSIZED,0},
	"fmul", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,0,0}, {R2,CPU_ALL,0,FUNC5(6LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fmul", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,0}, {RI,CPU_ALL,0,OPC(22LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fneg", {OP_VREG|OP_REG,OP_VREG|OP_REG,0,0,0}, {R2,CPU_ALL,0,RB(34LL)|FUNC5(1LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fsub", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,0,0}, {R2,CPU_ALL,0,FUNC5(4LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	"fsub", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,0}, {RI,CPU_ALL,0,OPC(20LL),6,SZ_FLTALL,SZ_DOUBLE, FLG_NEGIMM,FLG_FP},	
	"ftoi", {OP_VREG|OP_REG,OP_VREG|OP_REG,0,0,0}, {R2,CPU_ALL,0,RB(2LL)|FUNC5(1LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	

	"ibeq",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|0x1000LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ibge",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|0x1000LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibgeu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|0x1000LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ibgt",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(5LL)|0x1000LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibgtu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(5LL)|0x1000LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ibne",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(1LL)|0x1000LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ible",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(3LL)|0x1000LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibleu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(3LL)|0x1000LL|OPC(40LL),6,SZ_UNSIZED,0},
	"iblt",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(2LL)|0x1000LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibltu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(2LL)|0x1000LL|OPC(40LL),6,SZ_UNSIZED,0},

	"int",	{OP_IMM,OP_IMM,0,0,0}, {INT,CPU_ALL,0,0xA6LL,4},

	"itof", {OP_VREG|OP_REG,OP_VREG|OP_REG,0,0,0}, {R2,CPU_ALL,0,RB(3LL)|FUNC5(1LL)|OPC(12LL),6,SZ_FLTALL,SZ_DOUBLE,FLG_FP},	
	...
	"lda",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(4LL),6, SZ_UNSIZED, 0},	
	"lda",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(4LL),6, SZ_UNSIZED, 0},	
	"lda",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(10LL)|S(3)|OPC(79LL),6, SZ_UNSIZED, 0},	

	"ldb",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(64LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldb",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(64LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldb",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(0)|OPC(79LL),6, SZ_UNSIZED, SZ_BYTE},	

	"ldbu",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(65LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldbu",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(65LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldbu",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,LSFUNC(1LL)|CPU_ALL,0,OPC(79LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldbz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(65LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldbz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(65LL),6, SZ_UNSIZED, SZ_BYTE},	
	"ldbz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(1LL)|OPC(79LL),6, SZ_UNSIZED, SZ_BYTE},	

	"ldh",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(72LL),6, SZ_UNSIZED, SZ_HEXI},	
	"ldh",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(72LL),6, SZ_UNSIZED, SZ_HEXI},	
	"ldh",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(8LL)|OPC(79LL),6, SZ_UNSIZED, SZ_HEXI},	

	"ldi", {OP_VREG,OP_NEXT_VREG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(28LL),6,SZ_UNSIZED, 0},	
	"ldi", {OP_REG,OP_NEXTREG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(4LL),6,SZ_UNSIZED, 0},	

	"ldo",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(70LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldo",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(70LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldo",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(6LL)|OPC(79LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldou",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(71LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldou",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(71LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldou",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(7LL)|OPC(79LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldoz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(71LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldoz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(71LL),6, SZ_UNSIZED, SZ_OCTA},	
	"ldoz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(7LL)|OPC(79LL),6, SZ_UNSIZED, SZ_OCTA},	

	"ldt",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(68LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldt",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(68LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldt",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(4LL)|OPC(79LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldtu",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(69LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldtu",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(69LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldtu",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(5LL)|OPC(79LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldtz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(69LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldtz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(69LL),6, SZ_UNSIZED, SZ_TETRA},	
	"ldtz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(5LL)|OPC(79LL),6, SZ_UNSIZED, SZ_TETRA},	

	"ldw",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(66LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldw",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(66LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldw",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(2LL)|OPC(79LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldwu",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(67LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldwu",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(67LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldwu",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(3LL)|OPC(79LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldwz",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(67LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldwz",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(67LL),6, SZ_UNSIZED, SZ_WYDE},	
	"ldwz",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(3LL)|OPC(79LL),6, SZ_UNSIZED, SZ_WYDE},	

	"leave", {OP_IMM,OP_IMM,0,0,0}, {LEAVE,CPU_ALL,0,OPC(53LL),6,SZ_UNSIZED,0},	

	"load",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(70LL),6, SZ_UNSIZED, SZ_OCTA},	
	"load",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(70LL),6, SZ_UNSIZED, SZ_OCTA},	
	"load",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(6LL)|OPC(79LL),6, SZ_UNSIZED, SZ_OCTA},	
	"load",	{OP_VREG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(73LL),6, SZ_UNSIZED, SZ_OCTA},	
	"load",	{OP_VREG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(73LL),6, SZ_UNSIZED, SZ_OCTA},	
	"load",	{OP_VREG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(9LL)|OPC(79LL),6, SZ_UNSIZED, SZ_OCTA},	

	"loada",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(4LL),6, SZ_UNSIZED, 0},	
	"loada",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(4LL),6, SZ_UNSIZED, 0},	
	"loada",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(10LL)|S(3)|OPC(79LL),6, SZ_UNSIZED, 0},	

	"loadi", {OP_VREG,OP_NEXT_VREG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(28LL),6,SZ_UNSIZED, 0},	
	"loadi", {OP_REG,OP_NEXTREG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(4LL),6,SZ_UNSIZED, 0},	

	"lsr", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,SHFUNC(0x1LL)|OPC(88LL),6,SZ_UNSIZED,0},	
	"lsr", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,0x2000000000|SHFUNC(0x1LL)|OPC(88LL),6,SZ_UNSIZED,0},

	"max",	{OP_REG,OP_REG,OP_REG,OP_REG,0}, {R3RR,CPU_ALL,0,OPC(24LL),6},	
	"memdb",{0,0,0,0,0},{BITS16,CPU_ALL,0,0xff0000|OPC(114LL),6,SZ_UNSIZED,0},
	"memsb",{0,0,0,0,0},{BITS16,CPU_ALL,0,0xc00f00|OPC(114LL),6,SZ_UNSIZED,0},
	"min",	{OP_REG,OP_REG,OP_REG,OP_REG,0}, {R3RR,CPU_ALL,0,0x80000000|OPC(24LL),6},	

	"mod", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(25LL)|OPC(2),6,SZ_INTALL,SZ_HEXI},
	"mod", {OP_REG,OP_REG,OP_IMM,0,0}, {RIL,CPU_ALL,0,R2FUNC(25LL)|OPC(2),6,SZ_INTALL,SZ_HEXI},
	"modu", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(28LL)|OPC(2),6,SZ_INTALL,SZ_HEXI},
	"modu", {OP_REG,OP_REG,OP_IMM,0,0}, {RIL,CPU_ALL,0,R2FUNC(28LL)|OPC(2),6,SZ_INTALL,SZ_HEXI},

	"mov", {OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,OPC(15LL),6, SZ_UNSIZED, 0},	
	"move", {OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,OPC(15LL),6, SZ_UNSIZED, 0},	
//	"mov",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,0x0817F00000AALL,6},
//	"move",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,0x0817F00000AALL,6},
	"movsxb",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,BFFUNC(2LL)|BFME(7LL)|BFMB(0LL)|OPC(39LL),6},
	"movsxt",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,BFFUNC(2LL)|BFME(31LL)|BFMB(0LL)|OPC(39LL),6},
	"movsxw",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,BFFUNC(2LL)|BFME(15LL)|BFMB(0LL)|OPC(39LL),6},
	"movzxb",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,BFFUNC(3LL)|BFME(7LL)|BFMB(0LL)|OPC(39LL),6},
	"movzxt",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,BFFUNC(3LL)|BFME(31LL)|BFMB(0LL)|OPC(39LL),6},
	"movzxw",	{OP_REG,OP_REG,0,0,0}, {MV,CPU_ALL,0,BFFUNC(3LL)|BFME(15LL)|BFMB(0LL)|OPC(39LL),6},

	"mrts",	{0,0,0,0,0}, {RTS,CPU_ALL,0,0x01F2LL, 2},

	"mtlc",		{OP_NEXTREG,OP_REG,0,0,0}, {R2,CPU_ALL,0,0xA0000052LL,4},

	"mul", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(16LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"mul", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(6LL),6,SZ_UNSIZED,0,0},	
	...
	"mulf", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0x15LL,6},

	"mulh", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(24LL)|OPC(2LL),6},	

	"mulu", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(19LL)|OPC(2LL),6},	
	"mulu", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(14LL),6,SZ_UNSIZED,0,0},	

	"mux",	{OP_REG,OP_REG,OP_REG,OP_REG,0}, {R3RR,CPU_ALL,0,OPC(25),6},	
	...
	"nand", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(8LL)|OPC(2LL),6, SZ_INTALL, SZ_HEXI},	
	"nand", {OP_REG,OP_REG,OP_IMM,0}, {R3RI,CPU_ALL,0,R2FUNC(8LL)|OPC(2LL),6, SZ_INTALL, SZ_HEXI},	

	"neg", {OP_REG,OP_NEXTREG,OP_REG,0,0}, {R2,CPU_ALL,0,0x0000000DLL,4},	
//	"neg",	{OP_REG,OP_REG,0,0,0}, {R3,CPU_ALL,0,0x0A000001LL,4},

	"nop",	{0,0,0,0,0}, {BITS16,CPU_ALL,0,0xffffffffffffLL,6, SZ_UNSIZED, 0},
	...
	"nor", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {R2,CPU_ALL,0,R2FUNC(9LL)|OPC(2LL),6},	
	"not", {OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,R1FUNC(7LL)|OPC(1),6},

	"or", {OP_VREG,OP_VREG,OP_VREG,0,0}, {R2,CPU_ALL,0,R2FUNC(1LL)|OPC(38LL),6,SZ_UNSIZED,0},	
	"or", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(1LL)|OP3(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"or", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(1LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"or", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(9LL),6,SZ_UNSIZED,0,0},	

	"orf", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VMREG,0}, {R2M,CPU_ALL,0,R2FUNC(9LL)|OPC(2LL),6, SZ_INTALL, SZ_HEXI},
	"orf", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,OP_VMREG,0}, {RIM,CPU_ALL,0,OPC(9LL),6, SZ_INTALL, SZ_HEXI},
	"orf", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(9LL)|OPC(2LL),6, SZ_INTALL, SZ_HEXI},	
	"orf", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,0}, {RI,CPU_ALL,0,OPC(9LL),6, SZ_INTALL, SZ_HEXI},	

	"orh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x10000LL|OPC(51LL),6,SZ_UNSIZED,0,0},
	"orm",{OP_REG,OP_IMM,0,0,0}, {RISM,CPU_ALL,0,0x8000LL|OPC(51LL),6,SZ_UNSIZED,0,0},
	"ors",{OP_REG,OP_IMM,OP_IMM,0,0}, {RIS,CPU_ALL,0,OPC(51LL),6,SZ_UNSIZED,0,0},
	...
	"pcc",	{OP_REG,OP_PREDSTR,0,0,0}, {PRED,CPU_ALL,0,R2FUNC(32)|COND(11LL)|OPC(2LL),6, SZ_UNSIZED, 0},
	"pcs",	{OP_REG,OP_PREDSTR,0,0,0}, {PRED,CPU_ALL,0,R2FUNC(32)|COND(3LL)|OPC(2LL),6, SZ_UNSIZED, 0},
	"peq",	{OP_REG,OP_PREDSTR,0,0,0}, {PRED,CPU_ALL,0,R2FUNC(32)|COND(0LL)|OPC(2LL),6, SZ_UNSIZED, 0},
	"peven",	{OP_REG,OP_PREDSTR,0,0,0}, {PRED,CPU_ALL,0,R2FUNC(32)|COND(13LL)|OPC(2LL),6, SZ_UNSIZED, 0},

	"pfi",	{OP_REG,0,0,0,0},{R3RR,CPU_ALL,0,0x220000000007LL,6},	
	"pfx", 	{OP_IMM,0,0,0,0},{PFX,CPU_ALL,0,OPC(127LL),6,SZ_UNSIZED,0},

	"pop",	{OP_REG,OP_REG,OP_REG,OP_REG,OP_REG},{R5,CPU_ALL,0,0xA000000037LL,6},	
	"pop",	{OP_REG,OP_REG,OP_REG,OP_REG,0},{R4,CPU_ALL,0,0x8000000037LL,6},	
	"pop",	{OP_REG,OP_REG,OP_REG,0,0},{R3,CPU_ALL,0,0x6000000037LL,6},	
	"pop",	{OP_REG,OP_REG,0,0,0},{R3,CPU_ALL,0,0x4000000037LL,6},	
	"pop",	{OP_REG,0,0,0,0},{R3,CPU_ALL,0,0x2000000037LL,6},	
	...
	"pred",	{OP_NEXTREG,OP_REG,OP_PREDSTR,0,0}, {PRED,CPU_ALL,0,OPC(121LL),6, SZ_UNSIZED, 0},
	...
	"push",	{OP_REG,OP_REG,OP_REG,OP_REG,OP_REG},{R5,CPU_ALL,0,0xA000000036LL,6},	
	"push",	{OP_REG,OP_REG,OP_REG,OP_REG,0},{R4,CPU_ALL,0,0x8000000036LL,6},	
	"push",	{OP_REG,OP_REG,OP_REG,0,0},{R3,CPU_ALL,0,0x6000000036LL,6},	
	"push",	{OP_REG,OP_REG,0,0,0},{R3,CPU_ALL,0,0x4000000036LL,6},	
	"push",	{OP_REG,0,0,0,0},{R3,CPU_ALL,0,0x2000000036LL,6},
...
//	"rem", {OP_REG,OP_REG,OP_IMM,0,0}, {RIL,CPU_ALL,0,0x42LL,6},
	"repbc", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(6LL)|OPC(0LL),6},
	"repbs", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(7LL)|OPC(0LL),6},
	"repdeq", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(0LL),6},
	"repdge", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(4LL)|OPC(3LL),6},
	"repdgt", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(5LL)|OPC(3LL),6},
	"repdle", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(3LL),6},
	"repdlt", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(2LL),6},
	"repdne", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(1LL),6},
	"repeq", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(0LL),6},
	"repge", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(4LL)|OPC(3LL),6},
	"repgt", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(5LL)|OPC(3LL),6},
	"repibc", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(6LL)|OPC(2LL),6},
	"repibs", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(7LL)|OPC(2LL),6},
	"repieq", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(0LL)|OPC(2LL),6},
	"repige", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(4LL)|OPC(2LL),6},
	"repigt", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(5LL)|OPC(2LL),6},
	"repile", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(3LL)|OPC(2LL),6},
	"repilt", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(2LL)|OPC(2LL),6},
	"repine", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|0x8000|CND3(1LL)|OPC(2LL),6},
	"reple", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(3LL),6},
	"replt", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(2LL),6},
	"repne", {OP_IMM,OP_IMM,0,0,0},{REP,CPU_ALL,0,R2FUNC(34LL)|CND3(2LL)|OPC(1LL),6},
	...
	"revbit",	{OP_REG,OP_REG,0,0,0}, {R1,CPU_ALL,0,0x50000001LL,6},

//	"ret", {OP_REG,0,0,0,0}, {RTDR,CPU_ALL,0,0x80000000LL|R2FUNC(4LL)|OPC(2LL),6,SZ_INTALL,SZ_HEXI},	
	"ret", {OP_NEXTREG,OP_REG,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|LKS(1)|OPC(35LL),6,SZ_UNSIZED,0},	
	"ret", {0,0,0,0,0}, {RTDR,CPU_ALL,0,LKS(1LL)|RTYPE(0LL)|OPC(35LL),6,SZ_UNSIZED,0},	
	
	"retd", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {RTDR,CPU_ALL,0,0x80000000LL|R2FUNC(4LL)|LKS(1)|OPC(2LL),6,SZ_INTALL,SZ_HEXI},	
	"retd", {OP_NEXTREG,OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM}, {RTDI,CPU_ALL,0,0x80000000LL|LKS(1)|OPC(4LL),6,SZ_INTALL,SZ_HEXI},	
	"retd", {OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM}, {RTDI,CPU_ALL,0,0x80000000LL|LKS(1)|OPC(4LL),6,SZ_INTALL,SZ_HEXI},	
	"retd", {OP_NEXTREG,OP_IMM,OP_IMM,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|LKS(1LL)|OPC(35LL),6,SZ_INTALL,SZ_HEXI},	
	"retd", {OP_NEXTREG,OP_IMM,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|LKS(1LL)|OPC(35LL),6,SZ_INTALL,SZ_HEXI},	

	"rex",	{OP_IMM,OP_REG,0,0,0},{REX,CPU_ALL,0,0x200000000007LL,6},	

	"rol", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,SHFUNC(0x0LL)|OPC(88LL),6,SZ_UNSIZED,0},	
	"rol", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,SHFUNC(0x0LL)|0x2000000000|OPC(88LL),6,SZ_UNSIZED,0},	
	"ror", {OP_REG,OP_REG,OP_REG,0}, {SH,CPU_ALL,0,SHFUNC(0x1LL)|OPC(88LL),6,SZ_UNSIZED,0},	
	"ror", {OP_REG,OP_REG,OP_IMM,0}, {SI,CPU_ALL,0,SHFUNC(0x1LL)|0x2000000000|OPC(88LL),6,SZ_UNSIZED,0},	

	"rtd", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {RTDR,CPU_ALL,0,0x80000000LL|R2FUNC(4LL)|LKS(1)|OPC(2LL),6,SZ_INTALL,SZ_HEXI},	
	"rtd", {OP_NEXTREG,OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM}, {RTDI,CPU_ALL,0,0x80000000LL|LKS(1)|OPC(4LL),6,SZ_INTALL,SZ_HEXI},	
	"rtd", {OP_REG,OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM}, {RTDI,CPU_ALL,0,0x80000000LL|LKS(1)|OPC(4LL),6,SZ_INTALL,SZ_HEXI},	
	"rtd", {OP_NEXTREG,OP_IMM,OP_IMM,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|LKS(1LL)|OPC(35LL),6,SZ_INTALL,SZ_HEXI},	
	"rtd", {OP_NEXTREG,OP_IMM,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|LKS(1LL)|OPC(35LL),6,SZ_INTALL,SZ_HEXI},	

	"rte",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(1LL)|OPC(35LL), 6},
	"rte2",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(2LL)|OPC(35LL), 6},
	"rti",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(1LL)|OPC(35LL), 6},
	"rti2",	{0,0,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(2LL)|OPC(35LL), 6},
	"rts", {OP_NEXTREG,OP_REG,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|OPC(35LL),6,SZ_INTALL,SZ_HEXI},	
	"rts", {0,0,0,0,0}, {RTDR,CPU_ALL,0,RTYPE(0LL)|RA(56LL)|OPC(35LL),6,SZ_UNSIZED,0},	

	"sbx", {OP_VREG|OP_REG,OP_VREG|OP_REG,OP_IMM,OP_IMM,0}, {RII,CPU_ALL,0,FUNC3(3LL)|OPC(13LL),6,SZ_INTALL,SZ_HEXI},	

	"sei",	{OP_REG,OP_NEXTREG,OP_REG,0,0},{R3RR,CPU_ALL,0,0x2E0000000007LL,6},	

	"seq", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(16LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"seq", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(16LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"seq", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,R2FUNC(16LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sle", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(19LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sle", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(19LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sle", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,R2FUNC(19LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sleu", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(21LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sleu", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(21LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sleu", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,R2FUNC(21LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"slt", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(18LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"slt", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(18LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"slt", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(3LL),6,SZ_UNSIZED,0},	
...
//	"sll",	{OP_REG,OP_REG,OP_IMM,0,0}, {SHIFTI,CPU_ALL,0,0x800000000002LL,6},
	"sll",	{OP_REG,OP_REG,OP_IMM,0,0}, {RI6,CPU_ALL,0,SHFUNC(0LL)|OPC(88LL),6},
	"sll",	{OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,SHFUNC(0LL)|OPC(88LL),6},
...
//	"sne", {OP_REG,OP_REG,OP_REG,OP_REG,0}, {R3RR,CPU_ALL,0,0x4E0000000002LL,6},	
	"sne", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(17LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sne", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(17LL)|OPC(26LL),6,SZ_UNSIZED,0},	
	"sne", {OP_REG,OP_REG,OP_IMM,0,0}, {RIB,CPU_ALL,0,R2FUNC(17LL)|OPC(26LL),6,SZ_UNSIZED,0},	
...
//	"srl",	{OP_REG,OP_REG,OP_IMM,0,0}, {SHIFTI,CPU_ALL,0,0x820000000002LL,6},
	"srl",	{OP_REG,OP_REG,OP_IMM,0,0}, {RI6,CPU_ALL,0,SHFUNC(1LL)|OPC(88LL),6},
	"srl",	{OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,SHFUNC(1LL)|OPC(88LL),6},
	...
	"stb",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(80LL),6, SZ_UNSIZED, SZ_BYTE},	
	"stb",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(80LL),6, SZ_UNSIZED, SZ_BYTE},	
	"stb",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(0)|OPC(87LL),6, SZ_UNSIZED, SZ_BYTE},	

	"sth",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(84LL),6, SZ_UNSIZED, SZ_HEXI},	
	"sth",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(84LL),6, SZ_UNSIZED, SZ_HEXI},	
	"sth",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(4LL)|OPC(87LL),6, SZ_UNSIZED, SZ_HEXI},	

	"sto",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(83LL),6, SZ_UNSIZED, SZ_OCTA},	
	"sto",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(83LL),6, SZ_UNSIZED, SZ_OCTA},	
	"sto",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(3LL)|OPC(87LL),6, SZ_UNSIZED, SZ_OCTA},	
	"store",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(83LL),6, SZ_UNSIZED, SZ_OCTA},	
	"store",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(83LL),6, SZ_UNSIZED, SZ_OCTA},	
	"store",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(3LL)|OPC(87LL),6, SZ_UNSIZED, SZ_OCTA},	
	"store",	{OP_VREG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(85LL),6, SZ_UNSIZED, SZ_OCTA},	
	"store",	{OP_VREG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(85LL),6, SZ_UNSIZED, SZ_OCTA},	
	"store",	{OP_VREG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(5LL)|OPC(87LL),6, SZ_UNSIZED, SZ_OCTA},	

	"stt",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(82LL),6, SZ_UNSIZED, SZ_TETRA},	
	"stt",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(82LL),6, SZ_UNSIZED, SZ_TETRA},	
	"stt",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(2LL)|OPC(87LL),6, SZ_UNSIZED, SZ_TETRA},	

	"stw",	{OP_REG,OP_IMM,0,0,0}, {DIRECT,CPU_ALL,0,OPC(81LL),6, SZ_UNSIZED, SZ_WYDE},	
	"stw",	{OP_REG,OP_REGIND,0,0}, {REGIND,CPU_ALL,0,OPC(81LL),6, SZ_UNSIZED, SZ_WYDE},	
	"stw",	{OP_REG,OP_SCNDX,0,0,0}, {SCNDX,CPU_ALL,0,LSFUNC(1LL)|OPC(87LL),6, SZ_UNSIZED, SZ_WYDE},	

	"sub", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(4LL)|NRB(1LL)|OP3(3LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"sub", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(4LL),6,SZ_UNSIZED,0, FLG_NEGIMM},
	"subtract", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(4LL)|NRB(1LL)|OP3(3LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"subtract", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(4LL),6,SZ_UNSIZED,0, FLG_NEGIMM},

	"subf", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(5LL),6,SZ_UNSIZED,0},	
...
/* 0000_1010_0001_0001_1111_0000_0000_0000_0000_0000_AALL */
	...
	"sync", {OP_IMM,0,0,0,0}, {SYNC,CPU_ALL,0,0xFF00|OPC(114LL),6},
	"sys",	{OP_IMM,0,0,0,0}, {BITS40,CPU_ALL,0,OPC(0LL),6},
	"syscall",	{0,0,0,0,0}, {BITS40,CPU_ALL,0,OPC(0LL),6},

	"vmask",	{OP_VMSTR,0,0,0,0}, {VMASK,CPU_ALL,0,R2FUNC(34)|OPC(2),6},
	...
	"xor", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(2LL)|OP3(5LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"xor", {OP_REG,OP_IMM,OP_REG,0,0}, {RIA,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"xor", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,IPR(2LL)|OPC(10LL),6,SZ_UNSIZED,0,0},	
	"xorh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x10000LL|OPC(59LL),6,SZ_UNSIZED,0,0},
	"xorm",{OP_REG,OP_IMM,0,0,0}, {RISM,CPU_ALL,0,0x8000LL|OPC(59LL),6,SZ_UNSIZED,0,0},
	"xors",{OP_REG,OP_IMM,OP_IMM,0,0}, {RIS,CPU_ALL,0,OPC(59LL),6,SZ_UNSIZED,0,0},

	"zseq", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(120LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"zseq", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,OPC(94LL),6,SZ_UNSIZED,0},	
	"zsle", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(115LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"zsle", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(97LL),6,SZ_UNSIZED,0},	
	"zsleu", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(117LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"zsleu", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(101LL),6,SZ_UNSIZED,0},	
	"zslt", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(114LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	"zslt", {OP_REG,OP_REG,OP_IMM,0,0}, {RI,CPU_ALL,0,OPC(96LL),6,SZ_UNSIZED,0},	
};
...
*/
	...
	if (opt)
		val = hdiv(val,huge_from_int(6LL));
#endif
	return (val);
}
...
//  if (!eval_expr_huge(op->value,&val)) {
    ...
    if (btype > BASE_ILLEGAL) {
      ...
      if (OP_DATAM(op->type)) {  /* data operand */
        ...
        case RISM:
		      add_extnreloc_masked(reloclist,base,addend.lo,reloctype,
                         20,28,0,0xfffffff000000LL);
          break;
        case RISH:
		      add_extnreloc_masked(reloclist,base,addend.lo,reloctype,
	                       20,28,0,0xffff000000000000LL);
        	break;
        case RI:
        case RIV:
        case RIM:
...
{
	size_t isize = (insn->opcode & 0x7f)==7LL ? 6 : 6;
	...
	if (i==1) {
		if (insn) {
			...
			if (!is_nbit(hval,minbits)){//||(hval.lo&0x1FE00LL)==0x10000LL) {
				...
				if (!is_nbit(hval,32))
					insn->imm2 = OPC(59LL)|(((hval.lo >> 48LL) & 0xffffffLL)<<20LL)|SC(2LL)|RT(reg);	// ORI r51,#imm21<<32
/*
...
//				insn->opcode = insn->opcode | ((hval.lo & 0x1fffffLL) << 19LL);
		...
		if (!is_nbit(hval,minbits)) {
			if (insn) {
				insn->pfxb.size = 6;
				insn->pfxb.val = hval;
				insn->imm0 = OPC(9LL)|((hval.lo & 0xffffffLL) << 24LL)|RT(reg);	// ORI r51,r0,#imm16
				insn->imm1 = OPC(51LL)|(((hval.lo >> 24LL) & 0xffffffLL)<<20LL)|SC(1LL)|RT(reg);	// ORI r51,r51,#imm16<<16
				if (!is_nbit(hval,32)) {
					insn->pfxb.size = 10;
					insn->imm2 = OPC(51LL)|((hval.hi & 0xffffffLL)<<20LL)|SC(2LL)|RT(reg);	// ORI r51,r51,#imm16<<32
					insn->imm3 = OPC(51LL)|(((hval.hi >> 24LL) & 0xffffffLL)<<20LL)|SC(3LL)|RT(reg);	// ORI r51,r51,#imm16<<48
					if (!is_nbit(hval,64)) {
						insn->pfxb.size = 20;
					}
				}
	...
	)
{
	...
	if (abits < 24) {
		if (insn)
			insn->opcode = insn->opcode | ((val.lo & 0xffffffLL) << 24LL);
		return (isize);
	}
...
static size_t encode_immed_LDI(instruction_buf* insn, thuge hval, int i)
{
	...
	if (insn) {
		insn->opcode = insn->opcode | ((hval.lo & 0x7ffffLL) << 15LL);
		insn->size = 6;
	}
	if (i==1) {
		if (!is_nbit(hval,minbits)) {
...
//		hval.hi |= 0xFFFFFFFF00000000LL;
	...
	if (constexpr) {
		if (mnemo->ext.format==RI) {
			...
			if (insn) {
				if (i==1)
					insn->opcode = insn->opcode | (((val.lo >> 3LL) & 0x1fffffLL) << 27LL);
				else if (i==2)
					insn->opcode = insn->opcode | ((val.lo & 0x7LL) << 8LL);
			}
		}
			...
			if (insn) {
				if (i==1) {
					insn->opcode = insn->opcode | (((val.lo >> 24LL) & 0xfffffffLL) << 20LL);
				}
				else if (i==2) {
					insn->opcode = insn->opcode | ((val.lo & 0x7LL) << 15LL);
				}			
			}
		}
			...
			if (insn) {
				if (i==1) {
					insn->opcode = insn->opcode | (((val.lo >> 48LL) & 0xffffffLL) << 20LL);
				}
				else if (i==2) {
					insn->opcode = insn->opcode | ((val.lo & 0x7LL) << 15LL);
				}			
		...
		if (mnemo->ext.format==SI) {
			...
			if (insn) {
				if (i==1) {
					insn->opcode = insn->opcode | (((val.lo >> 24LL) & 0xffffffLL) << 20LL);
				}
				else if (i==2) {
					insn->opcode = insn->opcode | ((val.lo & 0x7LL) << 15LL);
				}			
			...
			if (insn) {
				if (i==1) {
					insn->opcode = insn->opcode | (((val.lo >> 48LL) & 0xfffffffLL) << 20LL);
				}
				else if (i==2) {
					insn->opcode = insn->opcode | ((val.lo & 0x7LL) << 15LL);
				}			
	...
	*isize = 6;
	...
	case JL2:
  	if (op->type==OP_IMM) {
	  	if (insn) {
    		uint64_t tgt;
    		tgt = ((val & 0xfffffLL) << 24LL) | (2LL << 22LL);
    		insn->opcode |= tgt;
	  	}
	  	return (1);
	  }
...
)
{
	...
	if (insn) {
		if (i==0)
			...
			insn->opcode |= (RA(op->basereg));
			insn->opcode |= (val.lo & 0xffffffLL) << 24LL;
		}
	}
	return (isize);
}
