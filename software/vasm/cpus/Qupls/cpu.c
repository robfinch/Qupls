...
//	"bodd",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(5LL)|OPC(28LL),5},
	...
	"jmp",	{OP_REGIND,0,0,0,0}, {J2,CPU_ALL,0,OPC(36LL),5, SZ_UNSIZED,0},
	"jmp",	{OP_REG,0,0,0,0}, {J2,CPU_ALL,0,OPC(36LL),5, SZ_UNSIZED,0},
	"jmp",	{OP_IMM,0,0,0,0}, {J2,CPU_ALL,0,OPC(36LL),5, SZ_UNSIZED,0},
	"jsr",	{OP_REGIND,0,0,0}, {J2,CPU_ALL,0,RT(57LL)|OPC(36LL),5, SZ_UNSIZED,0},
	"jsr",	{OP_REG,OP_IND_SCNDX,0,0,0}, {JSCNDX,CPU_ALL,0,R2FUNC(24LL)|0x80000000L|OPC(2LL),5, SZ_UNSIZED,0},
	"jsr",	{OP_REG,OP_REGIND,0,0,0}, {JL2,CPU_ALL,0,OPC(36LL),5, SZ_UNSIZED,0},
	"jsr",	{OP_REG,OP_IMM,0,0,0}, {JL2,CPU_ALL,0,OPC(36LL),5, SZ_UNSIZED,0},
	"jsr",	{OP_IMM,0,0,0,0}, {J2,CPU_ALL,0,RT(57LL)|OPC(36LL),5, SZ_UNSIZED,0},
