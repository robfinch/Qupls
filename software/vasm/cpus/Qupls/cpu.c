...
mnemonic mnemonics[]={
	...
	"add", {OP_VREG,OP_VREG,OP_VREG,0,0}, {R2,CPU_ALL,0,R2FUNC(4LL)|OP4(8LL)|OPC(38LL),6,SZ_UNSIZED,0},	
	"add", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(4LL)|OP4(8LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	...
	"addh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x18000LL|OPC(49LL),6,SZ_UNSIZED,0,0},
	...
	"andh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x18000LL|OPC(50LL),6,SZ_UNSIZED,0,0},
...
//	"bodd",	{OP_REG,OP_IMM,0,0,0}, {B,CPU_ALL,0,COND(5LL)|OPC(28LL),6},
	...
	"eor", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	...
	"eorh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x18000LL|OPC(59LL),6,SZ_UNSIZED,0,0},
	...
	"ibeq",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|0x800LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ibge",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|0x800LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibgeu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(4LL)|0x800LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ibgt",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(5LL)|0x800LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibgtu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(5LL)|0x800LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ibne",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(1LL)|0x800LL|OPC(40LL),6,SZ_UNSIZED,0},
	"ible",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(3LL)|0x800LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibleu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(3LL)|0x800LL|OPC(40LL),6,SZ_UNSIZED,0},
	"iblt",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(2LL)|0x800LL|OPC(41LL),6,SZ_UNSIZED,0},
	"ibltu",	{OP_REG,OP_REG,OP_IMM,0,0}, {B,CPU_ALL,0,BFN(2LL)|0x800LL|OPC(40LL),6,SZ_UNSIZED,0},
...
//	"neg",	{OP_REG,OP_REG,0,0,0}, {R3,CPU_ALL,0,0x0A000001LL,4},
	...
	"or", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(1LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	...
	"orh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x18000LL|OPC(51LL),6,SZ_UNSIZED,0,0},
...
/* 0000_1010_0001_0001_1111_0000_0000_0000_0000_0000_AALL */
	...
	"xor", {OP_REG,OP_REG,OP_REG,0,0}, {R2,CPU_ALL,0,R2FUNC(2LL)|OPC(2LL),6,SZ_UNSIZED,0},	
	...
	"xorh",{OP_REG,OP_IMM,0,0,0}, {RISH,CPU_ALL,0,0x18000LL|OPC(59LL),6,SZ_UNSIZED,0,0},
