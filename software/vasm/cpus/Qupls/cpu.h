...
#define RC(x)		(((x) & 0x1fLL) << 22LL)
#define CA(x)		(((x) & 7LL) << 29LL)
#define CAB(x)		(((x) & 7LL) << 24LL)
#define BFOFFS(x)	(((x) & 0x1fLL) << 17LL)
#define BFWID(x)	(((x) & 0x1fLL) << 22LL)
#define BFMB(x)	((((x) & 0x1fLL) << 17LL)|((((x) >> 5LL) & 1LL) << 28LL))
#define BFME(x)	(((x) & 0x3fLL) << 22LL)
